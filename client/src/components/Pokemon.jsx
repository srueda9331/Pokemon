...
export default function Pokemon({id, name, img, attack, typeOne, typeTwo, message}){
  return (

      message? 
        ( <div>
          <p id='pokemon-message'>{message}</p>
          <img id='img-poke-not-found' src='https://cdn.pixabay.com/photo/2019/11/18/15/46/pokemon-4635112_960_720.png' alt='empty-ball' />
          </div>
        ) 
        :
